...
export class UserCommand extends ArimaCommand {
	private static errorDescriptors = {
		...
		[PlaylistResolutionError.NotSuccessful]: `Something went wrong when finding that playlist. Please try again later, or submit a bug report on my [support server](${process.env.SUPPORT_SERVER_INVITE})`
	};
